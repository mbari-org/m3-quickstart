...
f you're currently using m3-quickstart to run a VARS system, simply run `git pull` and restart your services. Beyond that, there's no need for you to do anything at the moment. I've pinned the correct versions of the services for you to continue running VARS uninterrupted on your systems.
