...
# export VARS_KB_DATABASE_HIKARI_TEST="VALUES 1" # Derby
# export VARS_KB_DATABASE_HIKARI_TEST="SELECT 1" # Everything else mostly
...
export VARS_KB_DATABASE_USER="${M3_JDBC_USER}"
...
export VARS_USER_HTTP_CONTEXT_PATH=/users
...
export CHARYBDIS_ANNOSAURUS_URL="http://annosaurus:8080/v1"
...
export VARS_KB_SERVER_URL="http://${HOST_IP}:${VARS_KBSERVER_PORT}/v1"
export VARS_USER_SERVER_URL="http://${HOST_IP}:${VARS_KBSERVER_PORT}/v1"
...
export VARS_KB_SERVER_INTERNAL_URL="http://oni:8080/v1"
export VARS_USER_SERVER_INTERNAL_URL="http://oni:8080/v1"
